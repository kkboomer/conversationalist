...
async function onUpdate() {
    ...
    let response = await sendToServer(jsonData);

    faceTextController.updateText(response.emotion);
    // faceTextController.updateText("dummy emotion");
}
...
//@input Component.Script faceTextController
var faceTextController = script.faceTextController;