...
{
l9_136=strokeColorActive;
}
else
{
l9_136=strokeColorInactive;
}
l9_135=l9_136;
}
#else
...
#endif
vec4 l9_137=mix(mix(mix(l9_115,vec4(Port_Input1_N259),vec4(l9_0*l9_122)),vec4(shapeColor.xyz,1.0),l9_133),l9_134,vec4(l9_126));
float l9_138=l9_137.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_138<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_138<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_141=clamp(l9_138*2.0,0.0,1.0);
}
#else
{
float l9_142;
...
{
l9_142=clamp(dot(l9_137.xyz,vec3(l9_138)),0.0,1.0);
}
#else
{
float l9_143;
...
{
l9_144=(1.0-dot(l9_137.xyz,vec3(0.33333001)))*l9_138;
}
#else
{
float l9_145;
...
{
l9_145=(1.0-clamp(dot(l9_137.xyz,vec3(1.0)),0.0,1.0))*l9_138;
}
#else
{
float l9_146;
...
{
l9_146=clamp(dot(l9_137.xyz,vec3(1.0)),0.0,1.0)*l9_138;
}
#else
{
float l9_147;
#if (sc_BlendMode_Add)
{
l9_147=clamp(dot(l9_137.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_148;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_148=clamp(dot(l9_137.xyz,vec3(1.0)),0.0,1.0)*l9_138;
}
#else
{
float l9_149;
...
{
l9_149=dot(l9_137.xyz,vec3(0.33333001))*l9_138;
}
#else
{
float l9_150;
#if (sc_BlendMode_Min)
{
l9_150=1.0-clamp(dot(l9_137.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_151;
#if (sc_BlendMode_Max)
{
l9_151=clamp(dot(l9_137.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_151=1.0;
...
#endif
l9_139=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_137.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_140);
}
#else
{
vec4 l9_152;
...
#if (sc_FramebufferFetch)
{
l9_154=sc_readFragData0_Platform();
}
#else
{
vec2 l9_155=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_156;
...
#endif
l9_154=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_155,sc_ScreenTextureLayout,l9_156).xy,0.0);
}
#endif
vec3 l9_157=mix(l9_154.xyz,definedBlend(l9_154.xyz,l9_137.xyz).xyz,vec3(l9_138));
...
#if (sc_Voxelization)
{
l9_159=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_160;
#if (sc_OutputBounds)
{
float l9_161=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_160=vec4(l9_161,1.0-l9_161,1.0,1.0);
}
#else
{
vec4 l9_162;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_162=vec4(mix(vec3(1.0),l9_137.xyz,vec3(l9_138)),l9_138);
}
#else
{
vec4 l9_163;
...
#endif
l9_163=vec4(l9_137.xyz*l9_164,l9_164);
}
#else
{
l9_163=l9_137;
...
vec4 l9_167=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_165,vec4(0.0)));
