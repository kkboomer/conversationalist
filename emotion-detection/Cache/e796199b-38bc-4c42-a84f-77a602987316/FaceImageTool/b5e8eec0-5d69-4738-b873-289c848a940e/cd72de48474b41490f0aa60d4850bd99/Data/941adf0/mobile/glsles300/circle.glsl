...
//texture texture2DArray sc_ScreenTextureArrSC 0:30:0:22
...
#if (sc_RenderingSpace==3)
{
l9_4=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_5;
#if (sc_RenderingSpace==2)
{
l9_5=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_6;
#if (sc_RenderingSpace==1)
{
l9_6=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
l9_6=l9_1.position;
...
#if (sc_RenderingSpace==4)
{
l9_8=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_9;
#if (sc_RenderingSpace==2)
{
l9_9=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_10;
#if (sc_RenderingSpace==1)
{
l9_10=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_10=vec4(0.0);
...
#endif
varPackedTex=vec4(l9_1.texture0,l9_1.texture1);
#if (sc_ProjectiveShadowsReceiver)
{
vec4 l9_11;
#if (sc_RenderingSpace==1)
{
l9_11=sc_ModelMatrix*l9_1.position;
}
#else
{
l9_11=l9_1.position;
...
#endif
vec4 l9_12=sc_ProjectorMatrix*l9_11;
varShadowTex=((l9_12.xy/vec2(l9_12.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_13;
...
{
vec4 l9_15=l9_7;
l9_15.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_7.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_7.w;
l9_14=l9_15;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_17=l9_13.xy+(sc_TAAJitterOffset*l9_13.w);
l9_16=vec4(l9_17.x,l9_17.y,l9_13.z,l9_13.w);
}
#else
{
l9_16=l9_13;
...
#endif
sc_SetClipPosition(l9_16);
#if (sc_Voxelization)
{
sc_Vertex_t l9_18=l9_1;
sc_BlendVertex(l9_18);
sc_SkinVertex(l9_18);
int l9_19=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_20=int(voxelization_params_0.w);
vec4 l9_21=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_18.position).xyz+vec3(float(l9_19%l9_20)*voxelization_params_0.y,float(l9_19/l9_20)*voxelization_params_0.y,(float(l9_19)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_21.w=1.0;
varScreenPos=l9_21;
sc_SetClipPosition(l9_21*1.0);
}
#else
{
#if (sc_OutputBounds)
{
sc_Vertex_t l9_22=l9_1;
sc_BlendVertex(l9_22);
sc_SkinVertex(l9_22);
vec2 l9_23=((l9_22.position.xy/vec2(l9_22.position.w))*0.5)+vec2(0.5);
varPackedTex=vec4(l9_23.x,l9_23.y,varPackedTex.z,varPackedTex.w);
vec4 l9_24=sc_ModelMatrixVoxelization*l9_22.position;
vec3 l9_25=l9_24.xyz-voxelization_params_camera_pos;
varPos=l9_25.xyz;
varNormal=normalize(l9_22.normal);
vec4 l9_26=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_25.x,l9_25.y,l9_25.z,l9_24.w);
...
uniform bool Active;
uniform vec4 strokeColorActive;
uniform vec4 strokeColorInactive;
...
vec4 l9_1=vec4((((l9_0-0.0)/1.000001)*0.5)+0.5);
...
#if ((Tweak_N139)==1)
{
l9_6=clamp((((strokeThickness-0.0)/((1.0-0.0)+1e-06))*((-0.435)-(-0.5)))+(-0.5),-0.5,-0.435);
}
#else
{
l9_6=0.0;
...
float l9_7=floor(float(xLeftPin));
bool l9_8=l9_7==0.0;
float l9_9;
if (l9_8)
{
...
#if ((Tweak_N139)==1)
{
l9_12=clamp((((strokeThickness-0.0)/((1.0-0.0)+1e-06))*((-0.435)-(-0.5)))+(-0.5),-0.5,-0.435);
}
#else
{
l9_12=0.0;
...
float l9_13=1.0-0.0;
float l9_14=l9_13+1e-06;
float l9_15=(shapeWidthX-0.0)/l9_14;
float l9_16=l9_9-l9_3;
float l9_17=(l9_15*l9_16)+l9_3;
float l9_18;
if (l9_9>l9_3)
{
l9_18=clamp(l9_17,l9_3,l9_9);
}
else
{
l9_18=clamp(l9_17,l9_9,l9_3);
}
float l9_19;
if (l9_8)
{
...
if (l9_7==1.0)
{
l9_24=clamp((((strokeThickness-0.0)/l9_14)*((-0.064999998)-0.0))+0.0,-0.064999998,0.0);
}
else
{
l9_24=0.0;
...
#endif
float l9_25=(1.0-l9_20)+l9_21;
float l9_26=l9_18+l9_25;
float l9_27=floor(float(yUpPin));
float l9_28;
if (l9_27==0.0)
{
l9_28=0.0;
...
#if ((Tweak_N139)==1)
{
l9_31=clamp((((strokeThickness-0.0)/l9_14)*((-0.435)-(-0.5)))+(-0.5),-0.5,-0.435);
}
#else
{
l9_31=0.0;
...
float l9_32=floor(float(yDownPin));
bool l9_33=l9_32==0.0;
float l9_34;
if (l9_33)
{
l9_34=0.0;
...
#if ((Tweak_N139)==1)
{
l9_37=clamp((((strokeThickness-0.0)/l9_14)*((-0.435)-(-0.5)))+(-0.5),-0.5,-0.435);
}
#else
{
l9_37=0.0;
...
float l9_38=(shapeHeightY-0.0)/l9_14;
float l9_39=l9_34-l9_28;
float l9_40=(l9_38*l9_39)+l9_28;
float l9_41;
if (l9_34>l9_28)
{
l9_41=clamp(l9_40,l9_28,l9_34);
}
else
{
l9_41=clamp(l9_40,l9_34,l9_28);
}
float l9_42;
if (l9_33)
{
...
if (l9_32==1.0)
{
l9_47=clamp((((strokeThickness-0.0)/l9_14)*((-0.064999998)-0.0))+0.0,-0.064999998,0.0);
}
else
{
l9_47=0.0;
...
#endif
float l9_48=l9_43+l9_44;
float l9_49=l9_41+l9_48;
float l9_50=radians(0.0);
float l9_51=sin(l9_50);
float l9_52=cos(l9_50);
vec2 l9_53=(((varPackedTex.xy*vec2(1.0))+vec2(0.0))+vec2(l9_26,l9_49))-vec2(0.5);
vec2 l9_54=vec2(0.0);
l9_54.y=0.0/4.0;
float l9_55=radians(1.0-(0.0+1.0));
float l9_56=sin(l9_55);
float l9_57=cos(l9_55);
vec2 l9_58=((vec2(dot(vec2(l9_52,l9_51),l9_53),dot(vec2(-l9_51,l9_52),l9_53))+vec2(0.5))+l9_54)-vec2(0.5);
float l9_59=radians(shapeRotation);
float l9_60=sin(l9_59);
float l9_61=cos(l9_59);
vec2 l9_62=(vec2(dot(vec2(l9_57,l9_56),l9_58),dot(vec2(-l9_56,l9_57),l9_58))+vec2(0.5))-vec2(0.5);
vec2 l9_63=vec2(l9_61,l9_60);
vec2 l9_64=vec2(-l9_60,l9_61);
vec2 l9_65=abs((((((vec2(dot(l9_63,l9_62),dot(l9_64,l9_62))+vec2(0.5))-vec2(0.5))*vec2(clamp((((0.0-0.0)/l9_14)*(0.80000001-1.005))+1.005,0.80000001,1.005)))+vec2(0.5))*vec2(2.0))+vec2(-1.0));
float l9_66;
#if ((Tweak_N139)==0)
{
l9_66=0.0;
...
#endif
float l9_68=l9_66/7.5;
float l9_69=1.0-l9_68;
float l9_70=l9_69-0.0;
float l9_71=(l9_15*l9_70)+0.0;
bool l9_72=l9_69>0.0;
float l9_73;
if (l9_72)
{
l9_73=clamp(l9_71,0.0,l9_69);
}
else
{
l9_73=clamp(l9_71,l9_69,0.0);
}
float l9_74=(l9_38*l9_70)+0.0;
float l9_75;
if (l9_72)
{
l9_75=clamp(l9_74,0.0,l9_69);
}
else
{
l9_75=clamp(l9_74,l9_69,0.0);
}
vec2 l9_76=vec2(l9_73,l9_75);
float l9_77=min(abs(shapeRoundness),l9_73);
float l9_78=min(l9_77,l9_75);
float l9_79=max(l9_78,0.001);
vec2 l9_80=vec2(l9_79);
float l9_81=1.0-(length(max((l9_65-l9_76)+l9_80,vec2(0.0)))/l9_79);
float l9_82=fwidth(l9_81);
float l9_83=0.0*2.5;
float l9_84=l9_81/((((l9_82-0.0)/1.000001)*(1.0-l9_83))+l9_83);
float l9_85=(l9_15*l9_69)+l9_68;
bool l9_86=1.0>l9_68;
float l9_87;
if (l9_86)
{
l9_87=clamp(l9_85,l9_68,1.0);
}
else
{
l9_87=clamp(l9_85,1.0,l9_68);
}
float l9_88=(l9_38*l9_69)+l9_68;
float l9_89;
if (l9_86)
{
l9_89=clamp(l9_88,l9_68,1.0);
}
else
{
l9_89=clamp(l9_88,1.0,l9_68);
}
vec2 l9_90=vec2(l9_87,l9_89);
float l9_91=l9_66-0.0;
float l9_92=((l9_91/1.000001)*(clamp((((shapeRoundness-0.001)/((0.0099999998-0.001)+1e-06))*(0.16-0.0))+0.0,0.0,0.16)-0.0))+0.0;
float l9_93=(((shapeRoundness-0.0)/l9_14)*(1.0-l9_92))+l9_92;
float l9_94;
if (1.0>l9_92)
{
l9_94=clamp(l9_93,l9_92,1.0);
}
else
{
l9_94=clamp(l9_93,1.0,l9_92);
}
float l9_95=abs(l9_94);
float l9_96=min(l9_95,l9_87);
float l9_97=min(l9_96,l9_89);
float l9_98=max(l9_97,0.001);
vec2 l9_99=vec2(l9_98);
float l9_100=1.0-(length(max((l9_65-l9_90)+l9_99,vec2(0.0)))/l9_98);
float l9_101=fwidth(l9_100);
float l9_102;
#if ((Tweak_N139)==0)
{
l9_102=0.0;
...
#endif
vec4 l9_104=vec4(l9_1.x,l9_1.y,l9_1.z,vec4(0.0).w);
l9_104.w=((clamp(((shapeAlpha*(clamp(l9_84+0.001,0.001,1.001)-0.001))+((clamp(((clamp((1.0-l9_84)+0.001,0.001,1.001)-0.001)*(clamp((l9_100/((((l9_101-0.0)/1.000001)*l9_13)+0.0))+0.001,0.001,1.001)-0.001))+0.001,0.001,1.001)-0.001)*l9_102))+0.001,0.001,1.001)-0.001)*0.0)*l9_0;
vec2 l9_105=abs(((vec2(dot(l9_63,l9_53),dot(l9_64,l9_53))+vec2(0.5))*vec2(2.0))+vec2(-1.0));
float l9_106=1.0-(length(max((l9_105-l9_76)+l9_80,vec2(0.0)))/l9_79);
float l9_107=fwidth(l9_106);
float l9_108=clamp((l9_106/l9_107)+0.001,0.001,1.001)-0.001;
float l9_109=1.0-(length(max((l9_105-l9_90)+l9_99,vec2(0.0)))/l9_98);
float l9_110=fwidth(l9_109);
float l9_111=(clamp(((1.0-l9_108)*(clamp((l9_109/l9_110)+0.001,0.001,1.001)-0.001))+0.001,0.001,1.001)-0.001)*l9_102;
float l9_112=l9_108*shapeAlpha;
float l9_113;
#if (shapeColorInvert)
{
l9_113=1.001;
...
float l9_116=((((((l9_111+l9_112)-max(l9_111,l9_112))+l9_112)-0.0)/l9_14)*(l9_114-l9_115))+l9_115;
float l9_117;
if (l9_114>l9_115)
{
l9_117=clamp(l9_116,l9_115,l9_114);
}
else
{
l9_117=clamp(l9_116,l9_114,l9_115);
}
vec4 l9_118=vec4(l9_117);
vec4 l9_119;
#if ((Tweak_N139)==0)
{
l9_119=vec4(0.0);
...
{
vec4 l9_121;
if ((float(Active)*1.0)!=0.0)
{
l9_121=strokeColorActive;
}
else
{
l9_121=strokeColorInactive;
}
l9_120=l9_121;
}
#else
{
l9_120=vec4(1.0,0.0,0.0,0.0);
}
#endif
l9_119=l9_120;
}
#endif
vec4 l9_122=mix(mix(mix(l9_104,vec4(0.0),vec4(l9_0*l9_108)),vec4(shapeColor.xyz,1.0),l9_118),l9_119,vec4(l9_111));
float l9_123=l9_122.w;
...
{
l9_126=clamp(l9_123*2.0,0.0,1.0);
}
#else
{
float l9_127;
...
{
l9_127=clamp(dot(l9_122.xyz,vec3(l9_123)),0.0,1.0);
}
#else
{
float l9_128;
...
{
l9_129=(1.0-dot(l9_122.xyz,vec3(0.33333001)))*l9_123;
}
#else
{
float l9_130;
...
{
l9_130=(1.0-clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0))*l9_123;
}
#else
{
float l9_131;
...
{
l9_131=clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0)*l9_123;
}
#else
{
float l9_132;
#if (sc_BlendMode_Add)
{
l9_132=clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_133;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_133=clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0)*l9_123;
}
#else
{
float l9_134;
...
{
l9_134=dot(l9_122.xyz,vec3(0.33333001))*l9_123;
}
#else
{
float l9_135;
#if (sc_BlendMode_Min)
{
l9_135=1.0-clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_136;
#if (sc_BlendMode_Max)
{
l9_136=clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_136=1.0;
...
#endif
l9_124=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_122.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_125);
}
#else
{
vec4 l9_137;
...
#if (sc_FramebufferFetch)
{
l9_139=sc_readFragData0_Platform();
}
#else
{
vec2 l9_140=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_141;
#if (sc_ScreenTextureLayout==2)
{
l9_141=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_140,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_141=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_140,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_139=l9_141;
}
#endif
vec3 l9_142=mix(l9_139.xyz,definedBlend(l9_139.xyz,l9_122.xyz).xyz,vec3(l9_123));
vec4 l9_143=vec4(l9_142.x,l9_142.y,l9_142.z,vec4(0.0).w);
l9_143.w=1.0;
l9_138=l9_143;
}
#else
...
#if (sc_Voxelization)
{
l9_144=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_145;
#if (sc_OutputBounds)
{
float l9_146=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_145=vec4(l9_146,1.0-l9_146,1.0,1.0);
}
#else
{
vec4 l9_147;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_147=vec4(mix(vec3(1.0),l9_122.xyz,vec3(l9_123)),l9_123);
}
#else
{
vec4 l9_148;
...
#endif
l9_148=vec4(l9_122.xyz*l9_149,l9_149);
}
#else
{
l9_148=l9_122;
...
#endif
vec4 l9_150=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_124,vec4(0.0)));
...
mediump vec4 l9_192=texture(sc_OITFilteredDepthBoundsTexture,l9_166);
