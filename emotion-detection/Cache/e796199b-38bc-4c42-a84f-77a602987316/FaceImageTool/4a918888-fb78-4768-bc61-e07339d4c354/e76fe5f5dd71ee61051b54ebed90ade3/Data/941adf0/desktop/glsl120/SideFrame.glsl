...
vec4 l9_3=l9_1*Port_Default_N369;
...
#endif
l9_21=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_22,sc_ScreenTextureLayout,l9_23).xy,0.0);
}
#endif
...
vec4 l9_34=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_32,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_36-0.0039215689)),min(1.0,l9_36+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_37=sc_ScreenCoordsGlobalToView(l9_0);
...
sc_writeFragData0Internal(vec4(packValue(l9_38),packValue(l9_38),packValue(l9_38),packValue(l9_38)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_50=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
sc_writeFragData0Internal(l9_35,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_34,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
