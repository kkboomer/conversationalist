...
//texture texture2DArray intensityTextureArrSC 0:28:0:18
...
uniform bool Active;
uniform vec4 ColorActive;
uniform bool Hover;
uniform vec4 ColorHover;
uniform vec4 ColorInactive;
...
#if (sc_FramebufferFetch)
{
l9_21=sc_readFragData0_Platform();
}
#else
{
vec2 l9_22=sc_ScreenCoordsGlobalToView(l9_0);
vec4 l9_23;
#if (sc_ScreenTextureLayout==2)
{
l9_23=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_22,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_23=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_22,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_21=l9_23;
}
#endif
vec3 l9_24=mix(l9_21.xyz,definedBlend(l9_21.xyz,l9_5.xyz).xyz,vec3(l9_4));
...
#if (sc_Voxelization)
{
l9_26=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_27;
#if (sc_OutputBounds)
{
float l9_28=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_27=vec4(l9_28,1.0-l9_28,1.0,1.0);
}
#else
{
vec4 l9_29;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_4)),l9_4);
}
#else
{
vec4 l9_30;
...
#endif
l9_30=vec4(l9_5.xyz*l9_31,l9_31);
}
#else
{
l9_30=l9_5;
...
#endif
vec4 l9_32=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_6,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_35=sc_ScreenCoordsGlobalToView(l9_0);
...
#if (sc_OITCompositingPass)
{
vec2 l9_48=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
mediump vec4 l9_74=texture(sc_OITFilteredDepthBoundsTexture,l9_48);
vec2 l9_75=l9_74.xy;
int l9_76;
#if (sc_SkinBonesCount>0)
{
