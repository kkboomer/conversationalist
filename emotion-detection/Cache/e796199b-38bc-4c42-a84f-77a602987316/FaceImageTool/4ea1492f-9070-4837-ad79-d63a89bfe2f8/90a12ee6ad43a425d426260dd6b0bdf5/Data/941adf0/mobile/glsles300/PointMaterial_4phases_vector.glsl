...
uniform int iState;
uniform float edited_scale;
uniform vec4 edited_OutlineColor;
uniform vec4 edited_baseColor;
uniform float hover_scale;
uniform vec4 hover_outlineColor;
uniform vec4 hoverbaseColor;
uniform float selected_scale;
uniform vec4 selected_outline_color;
uniform vec4 selected_base_color;
uniform float default_scale;
uniform vec4 default_outline_color;
uniform vec4 default_base_color;
...
in vec4 varColor;
void Node30_Switch(float Switch,vec4 Value0,vec4 Value1,vec4 Value2,vec4 Default,out vec4 Result,ssGlobals Globals)
{
Switch=float(iState);
Switch=floor(Switch);
if (Switch==0.0)
{
float l9_0=length((((Globals.Surface_UVCoord0-vec2(0.5))*vec2(edited_scale))+vec2(0.5))-vec2(0.5));
float l9_1=float(l9_0<0.34);
float l9_2=float(l9_0<0.255);
vec3 l9_3=vec3(l9_2);
vec3 l9_4=mix((vec3(l9_1)*edited_OutlineColor.xyz).xyz,(l9_3*edited_baseColor.xyz).xyz,l9_3);
vec4 l9_5=vec4(l9_4.x,l9_4.y,l9_4.z,vec4(0.0).w);
l9_5.w=clamp((l9_1+l9_2)+0.001,0.001,1.001)-0.001;
Value0=l9_5;
Result=Value0;
}
else
...
if (Switch==1.0)
{
float l9_6=length((((Globals.Surface_UVCoord0-vec2(0.5))*vec2(hover_scale))+vec2(0.5))-vec2(0.5));
float l9_7=float(l9_6<0.34);
float l9_8=float(l9_6<0.255);
vec3 l9_9=vec3(l9_8);
vec3 l9_10=mix((vec3(l9_7)*hover_outlineColor.xyz).xyz,(l9_9*hoverbaseColor.xyz).xyz,l9_9);
vec4 l9_11=vec4(l9_10.x,l9_10.y,l9_10.z,vec4(0.0).w);
l9_11.w=clamp((l9_7+l9_8)+0.001,0.001,1.001)-0.001;
Value1=l9_11;
Result=Value1;
}
else
...
if (Switch==2.0)
{
float l9_12=length((((Globals.Surface_UVCoord0-vec2(0.5))*vec2(selected_scale))+vec2(0.5))-vec2(0.5));
float l9_13=float(l9_12<0.34);
float l9_14=float(l9_12<0.255);
vec3 l9_15=vec3(l9_14);
vec3 l9_16=mix((vec3(l9_13)*selected_outline_color.xyz).xyz,(l9_15*selected_base_color.xyz).xyz,l9_15);
vec4 l9_17=vec4(l9_16.x,l9_16.y,l9_16.z,vec4(0.0).w);
l9_17.w=clamp((l9_13+l9_14)+0.001,0.001,1.001)-0.001;
Value2=l9_17;
Result=Value2;
}
else
{
float l9_18=length((((Globals.Surface_UVCoord0-vec2(0.5))*vec2(default_scale))+vec2(0.5))-vec2(0.5));
float l9_19=float(l9_18<0.34);
float l9_20=float(l9_18<0.255);
vec3 l9_21=vec3(l9_20);
vec3 l9_22=mix((vec3(l9_19)*default_outline_color.xyz).xyz,(l9_21*default_base_color.xyz).xyz,l9_21);
vec4 l9_23=vec4(l9_22.x,l9_22.y,l9_22.z,vec4(0.0).w);
l9_23.w=clamp((l9_19+l9_20)+0.001,0.001,1.001)-0.001;
Default=l9_23;
Result=Default;
}
}
...
#endif
vec4 param_5;
Node30_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),param_5,ssGlobals(sc_Time.x,sc_Time.y,0.0,varPackedTex.xy));
vec4 l9_0=param_5;
...
#if (sc_FramebufferFetch)
{
l9_16=sc_readFragData0_Platform();
}
#else
{
vec2 l9_17=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_18;
#if (sc_ScreenTextureLayout==2)
{
l9_18=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_17,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_18=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_17,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_16=l9_18;
}
#endif
vec3 l9_19=mix(l9_16.xyz,definedBlend(l9_16.xyz,l9_0.xyz).xyz,vec3(l9_0.w));
...
#if (sc_Voxelization)
{
l9_21=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_22;
#if (sc_OutputBounds)
{
float l9_23=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_22=vec4(l9_23,1.0-l9_23,1.0,1.0);
}
#else
{
vec4 l9_24;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_24=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_0.w)),l9_0.w);
}
#else
{
vec4 l9_25;
...
#endif
l9_25=vec4(l9_0.xyz*l9_26,l9_26);
}
#else
{
l9_25=l9_0;
...
#endif
vec4 l9_27=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_1,vec4(0.0)));
vec4 l9_28=clamp(l9_27,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_29=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_29-0.0039215689)),min(1.0,l9_29+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_30=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_30).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_31=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_30).xy);
float l9_32=packValue(l9_31);
int l9_39=int(l9_28.w*255.0);
float l9_40=packValue(l9_39);
sc_writeFragData0Internal(vec4(packValue(l9_31),packValue(l9_31),packValue(l9_31),packValue(l9_31)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_32,packValue(l9_31),packValue(l9_31),packValue(l9_31)));
sc_writeFragData2(vec4(l9_40,packValue(l9_39),packValue(l9_39),packValue(l9_39)));
...
if (l9_48==0)
{
l9_51=texture(sc_OITAlpha0,l9_43);
l9_50=texture(sc_OITDepthLow0,l9_43);
l9_49=texture(sc_OITDepthHigh0,l9_43);
}
else
{
l9_51=vec4(0.0);
...
if (l9_48==1)
{
l9_54=texture(sc_OITAlpha1,l9_43);
l9_53=texture(sc_OITDepthLow1,l9_43);
l9_52=texture(sc_OITDepthHigh1,l9_43);
}
else
{
l9_54=l9_51;
...
if (any(notEqual(l9_52,vec4(0.0)))||any(notEqual(l9_53,vec4(0.0))))
{
int l9_55[8]=l9_44;
unpackValues(l9_52.w,l9_48,l9_55);
unpackValues(l9_52.z,l9_48,l9_55);
unpackValues(l9_52.y,l9_48,l9_55);
unpackValues(l9_52.x,l9_48,l9_55);
unpackValues(l9_53.w,l9_48,l9_55);
unpackValues(l9_53.z,l9_48,l9_55);
unpackValues(l9_53.y,l9_48,l9_55);
unpackValues(l9_53.x,l9_48,l9_55);
int l9_64[8]=l9_45;
unpackValues(l9_54.w,l9_48,l9_64);
unpackValues(l9_54.z,l9_48,l9_64);
unpackValues(l9_54.y,l9_48,l9_64);
unpackValues(l9_54.x,l9_48,l9_64);
}
l9_48++;
continue;
}
...
mediump vec4 l9_69=texture(sc_OITFilteredDepthBoundsTexture,l9_43);
vec2 l9_70=l9_69.xy;
int l9_71;
#if (sc_SkinBonesCount>0)
{
l9_71=encodeDepth(((1.0-l9_69.x)*1000.0)+getDepthOrderingEpsilon(),l9_70);
}
#else
{
l9_71=0;
...
#endif
int l9_72=encodeDepth(viewSpaceDepth(),l9_70);
vec4 l9_73;
l9_73=l9_28*l9_28.w;
vec4 l9_74;
int l9_75=0;
...
if (l9_75<8)
{
int l9_76=l9_44[l9_75];
int l9_77=l9_72-l9_71;
bool l9_78=l9_76<l9_77;
bool l9_79;
if (l9_78)
{
l9_79=l9_44[l9_75]>0;
...
if (l9_79)
{
vec3 l9_80=l9_73.xyz*(1.0-(float(l9_45[l9_75])/255.0));
l9_74=vec4(l9_80.x,l9_80.y,l9_80.z,l9_73.w);
}
else
{
l9_74=l9_73;
