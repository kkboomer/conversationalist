...
uniform vec2 Port_Center_N009;
uniform vec2 Port_Input1_N001;
uniform float Port_Input_N012;
uniform float Port_Input_N017;
uniform float Port_Input1_N028;
uniform float Port_Input2_N028;
uniform vec2 Port_Center_N031;
uniform vec2 Port_Input1_N032;
uniform float Port_Input_N034;
uniform float Port_Input_N041;
uniform float Port_Input1_N057;
uniform float Port_Input2_N057;
uniform vec2 Port_Center_N078;
uniform vec2 Port_Input1_N079;
uniform float Port_Input_N082;
uniform float Port_Input_N089;
uniform float Port_Input1_N105;
uniform float Port_Input2_N105;
uniform vec2 Port_Center_N114;
uniform vec2 Port_Input1_N115;
uniform float Port_Input_N117;
uniform float Port_Input_N124;
uniform float Port_Input1_N140;
uniform float Port_Input2_N140;
...
if (Switch==0.0)
{
float l9_0=length((((Globals.Surface_UVCoord0-Port_Center_N009)*vec2(edited_scale))+Port_Center_N009)-Port_Input1_N001);
float l9_1=float(l9_0<Port_Input_N012);
float l9_2=float(l9_0<Port_Input_N017);
vec3 l9_3=vec3(l9_2);
...
l9_5.w=clamp((l9_1+l9_2)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
Value0=l9_5;
Result=Value0;
}
else
...
if (Switch==1.0)
{
float l9_6=length((((Globals.Surface_UVCoord0-Port_Center_N031)*vec2(hover_scale))+Port_Center_N031)-Port_Input1_N032);
float l9_7=float(l9_6<Port_Input_N034);
float l9_8=float(l9_6<Port_Input_N041);
vec3 l9_9=vec3(l9_8);
...
l9_11.w=clamp((l9_7+l9_8)+0.001,Port_Input1_N057+0.001,Port_Input2_N057+0.001)-0.001;
Value1=l9_11;
Result=Value1;
}
else
...
if (Switch==2.0)
{
float l9_12=length((((Globals.Surface_UVCoord0-Port_Center_N078)*vec2(selected_scale))+Port_Center_N078)-Port_Input1_N079);
float l9_13=float(l9_12<Port_Input_N082);
float l9_14=float(l9_12<Port_Input_N089);
...
l9_17.w=clamp((l9_13+l9_14)+0.001,Port_Input1_N105+0.001,Port_Input2_N105+0.001)-0.001;
Value2=l9_17;
Result=Value2;
}
else
{
float l9_18=length((((Globals.Surface_UVCoord0-Port_Center_N114)*vec2(default_scale))+Port_Center_N114)-Port_Input1_N115);
float l9_19=float(l9_18<Port_Input_N117);
float l9_20=float(l9_18<Port_Input_N124);
...
l9_23.w=clamp((l9_19+l9_20)+0.001,Port_Input1_N140+0.001,Port_Input2_N140+0.001)-0.001;
Default=l9_23;
Result=Default;
}
}
...
#endif
l9_16=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_17,sc_ScreenTextureLayout,l9_18).xy,0.0);
}
#endif
...
vec4 l9_29=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_27,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_32=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
#if (sc_OITCompositingPass)
{
vec2 l9_45=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
