...
float l9_113=1.0-l9_0;
float l9_114=((((((l9_111+l9_112)-max(l9_111,l9_112))+l9_112)-0.0)/l9_14)*(l9_0-l9_113))+l9_113;
float l9_115;
if (l9_0>l9_113)
{
l9_115=clamp(l9_114,l9_113,l9_0);
}
else
{
l9_115=clamp(l9_114,l9_0,l9_113);
}
vec4 l9_116=vec4(l9_115);
vec4 l9_117;
#if ((Tweak_N139)==0)
{
l9_117=vec4(0.0);
...
#else
{
l9_118=vec4(1.0,0.0,0.0,0.0);
}
#endif
l9_117=l9_118;
}
#endif
vec4 l9_119=mix(mix(mix(l9_104,vec4(0.0),vec4(l9_0*l9_108)),vec4(shapeColor.xyz,1.0),l9_116),l9_117,vec4(l9_111));
float l9_120=l9_119.w;
...
{
l9_123=clamp(l9_120*2.0,0.0,1.0);
}
#else
{
float l9_124;
...
{
l9_124=clamp(dot(l9_119.xyz,vec3(l9_120)),0.0,1.0);
}
#else
{
float l9_125;
...
{
l9_126=(1.0-dot(l9_119.xyz,vec3(0.33333001)))*l9_120;
}
#else
{
float l9_127;
...
{
l9_127=(1.0-clamp(dot(l9_119.xyz,vec3(1.0)),0.0,1.0))*l9_120;
}
#else
{
float l9_128;
...
{
l9_128=clamp(dot(l9_119.xyz,vec3(1.0)),0.0,1.0)*l9_120;
}
#else
{
float l9_129;
#if (sc_BlendMode_Add)
{
l9_129=clamp(dot(l9_119.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_130;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_130=clamp(dot(l9_119.xyz,vec3(1.0)),0.0,1.0)*l9_120;
}
#else
{
float l9_131;
...
{
l9_131=dot(l9_119.xyz,vec3(0.33333001))*l9_120;
}
#else
{
float l9_132;
#if (sc_BlendMode_Min)
{
l9_132=1.0-clamp(dot(l9_119.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_133;
#if (sc_BlendMode_Max)
{
l9_133=clamp(dot(l9_119.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_133=1.0;
...
#endif
l9_121=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_119.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_122);
}
#else
{
vec4 l9_134;
...
#if (sc_FramebufferFetch)
{
l9_136=sc_readFragData0_Platform();
}
#else
{
vec2 l9_137=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_138;
#if (sc_ScreenTextureLayout==2)
{
l9_138=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_137,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_138=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_137,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_136=l9_138;
}
#endif
vec3 l9_139=mix(l9_136.xyz,definedBlend(l9_136.xyz,l9_119.xyz).xyz,vec3(l9_120));
vec4 l9_140=vec4(l9_139.x,l9_139.y,l9_139.z,vec4(0.0).w);
l9_140.w=1.0;
l9_135=l9_140;
}
#else
...
#if (sc_Voxelization)
{
l9_141=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_142;
#if (sc_OutputBounds)
{
float l9_143=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_142=vec4(l9_143,1.0-l9_143,1.0,1.0);
}
#else
{
vec4 l9_144;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_144=vec4(mix(vec3(1.0),l9_119.xyz,vec3(l9_120)),l9_120);
}
#else
{
vec4 l9_145;
...
#endif
l9_145=vec4(l9_119.xyz*l9_146,l9_146);
}
#else
{
l9_145=l9_119;
...
#endif
vec4 l9_147=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_121,vec4(0.0)));
...
mediump vec4 l9_189=texture(sc_OITFilteredDepthBoundsTexture,l9_163);
