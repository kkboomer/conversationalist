...
float l9_128=1.0-l9_0;
float l9_129=((((((l9_126+l9_127)-max(l9_126,l9_127))+l9_127)-Port_RangeMinA_N143)/((Port_RangeMaxA_N143-Port_RangeMinA_N143)+1e-06))*(l9_0-l9_128))+l9_128;
float l9_130;
if (l9_0>l9_128)
{
l9_130=clamp(l9_129,l9_128,l9_0);
}
else
{
l9_130=clamp(l9_129,l9_0,l9_128);
}
vec4 l9_131=vec4(l9_130);
vec4 l9_132;
#if ((Tweak_N139)==0)
{
l9_132=Port_Value0_N140;
}
#else
{
vec4 l9_133;
...
#else
{
l9_133=Port_Default_N140;
}
#endif
l9_132=l9_133;
}
#endif
vec4 l9_134=mix(mix(mix(l9_115,vec4(Port_Input1_N259),vec4(l9_0*l9_122)),vec4(shapeColor.xyz,1.0),l9_131),l9_132,vec4(l9_126));
float l9_135=l9_134.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_135<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_135<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_138=clamp(l9_135*2.0,0.0,1.0);
}
#else
{
float l9_139;
...
{
l9_139=clamp(dot(l9_134.xyz,vec3(l9_135)),0.0,1.0);
}
#else
{
float l9_140;
...
{
l9_141=(1.0-dot(l9_134.xyz,vec3(0.33333001)))*l9_135;
}
#else
{
float l9_142;
...
{
l9_142=(1.0-clamp(dot(l9_134.xyz,vec3(1.0)),0.0,1.0))*l9_135;
}
#else
{
float l9_143;
...
{
l9_143=clamp(dot(l9_134.xyz,vec3(1.0)),0.0,1.0)*l9_135;
}
#else
{
float l9_144;
#if (sc_BlendMode_Add)
{
l9_144=clamp(dot(l9_134.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_145;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_145=clamp(dot(l9_134.xyz,vec3(1.0)),0.0,1.0)*l9_135;
}
#else
{
float l9_146;
...
{
l9_146=dot(l9_134.xyz,vec3(0.33333001))*l9_135;
}
#else
{
float l9_147;
#if (sc_BlendMode_Min)
{
l9_147=1.0-clamp(dot(l9_134.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_148;
#if (sc_BlendMode_Max)
{
l9_148=clamp(dot(l9_134.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_148=1.0;
...
#endif
l9_136=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_134.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_137);
}
#else
{
vec4 l9_149;
...
#endif
l9_151=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_152,sc_ScreenTextureLayout,l9_153).xy,0.0);
}
#endif
vec3 l9_154=mix(l9_151.xyz,definedBlend(l9_151.xyz,l9_134.xyz).xyz,vec3(l9_135));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_159=vec4(mix(vec3(1.0),l9_134.xyz,vec3(l9_135)),l9_135);
}
#else
{
vec4 l9_160;
...
#endif
l9_160=vec4(l9_134.xyz*l9_161,l9_161);
}
#else
{
l9_160=l9_134;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_167).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_168=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_167).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_180).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_185==0)
{
l9_188=texture2D(sc_OITAlpha0,l9_180);
l9_187=texture2D(sc_OITDepthLow0,l9_180);
l9_186=texture2D(sc_OITDepthHigh0,l9_180);
}
else
{
l9_188=vec4(0.0);
...
if (l9_185==1)
{
l9_191=texture2D(sc_OITAlpha1,l9_180);
l9_190=texture2D(sc_OITDepthLow1,l9_180);
l9_189=texture2D(sc_OITDepthHigh1,l9_180);
}
else
{
l9_191=l9_188;
...
vec4 l9_206=texture2D(sc_OITFilteredDepthBoundsTexture,l9_180);
