...
//texture texture2DArray baseTexArrSC 0:27:0:17
...
//spec_const bool Tweak_N121 37 0
//spec_const bool UseViewSpaceDepthVariant 38 1
//spec_const bool baseTexHasSwappedViews 39 0
...
#endif
vec4 l9_51=baseColor*l9_1;
float l9_52=l9_51.w*1.0;
vec4 l9_53=vec4(l9_51.x,l9_51.y,l9_51.z,vec4(0.0).w);
l9_53.w=l9_52;
...
#else
{
vec2 l9_70=sc_ScreenCoordsGlobalToView(l9_0);
vec4 l9_71;
...
#endif
vec4 l9_80=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_54,vec4(0.0)));
...
mediump vec4 l9_122=texture(sc_OITFilteredDepthBoundsTexture,l9_96);
