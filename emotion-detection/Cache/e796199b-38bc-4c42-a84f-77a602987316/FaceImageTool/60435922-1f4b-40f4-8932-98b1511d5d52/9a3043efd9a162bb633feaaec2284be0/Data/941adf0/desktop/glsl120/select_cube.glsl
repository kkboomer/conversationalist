...
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),baseTexLayout,l9_2);
vec4 l9_25=texture2D(baseTex,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
vec4 l9_27=baseColor*l9_1;
float l9_28=l9_27.w*Port_Default_N204;
...
#endif
vec3 l9_48=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_29.xyz).xyz,vec3(l9_28));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_28)),l9_28);
}
#else
{
vec4 l9_54;
...
#endif
l9_54=vec4(l9_29.xyz*l9_55,l9_55);
}
#else
{
l9_54=l9_29;
